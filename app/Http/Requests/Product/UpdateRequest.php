...
{
    /**
     * Autoriza atualização de produtos (controlado via rota/middleware).
     */
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'quantidade_estoque' => 'sometimes|required|numeric|min:0',
        ];
    }

    /**
     * Mensagens de erro em português para atualização de produto.
     */
